...
func (cu *CustomerUpdate) SetEmailAddress(s string) *CustomerUpdate {
	cu.mutation.SetEmailAddress(s)
	return cu
}
...
func (cu *CustomerUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.EmailAddress(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: customer.FieldEmailAddress,
		})
	}
...
// SetEmailAddress sets the "email_address" field.
func (cuo *CustomerUpdateOne) SetEmailAddress(s string) *CustomerUpdateOne {
	cuo.mutation.SetEmailAddress(s)
	return cuo
}
...
func (cuo *CustomerUpdateOne) sqlSave(ctx context.Context) (_node *Customer, err error) {
	...
	if value, ok := cuo.mutation.EmailAddress(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: customer.FieldEmailAddress,
